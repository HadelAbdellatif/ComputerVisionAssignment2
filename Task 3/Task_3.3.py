...
# Function to calculate color moments (mean, median, mode, standard deviation, skewness, and kurtosis)
...
def weighted_euclidean_distance(moment1, moment2, weights):
    m1 = moment1.reshape(3, 5)
    m2 = moment2.reshape(3, 5)
...
if __name__ == "__main__":
    ...
    weights = np.array([1.0, 0.8, 0.5])  # same weights as 3.2
